...
/** Модули интерфейса: stats, data, monitor, analysis, consolidation, docs, settings, shipments */
const MODULES_BY_ROLE = {
  admin: ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings', 'shipments'],
  group_leader: ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings', 'shipments'],
  supervisor: ['stats', 'data', 'monitor', 'analysis', 'docs', 'shipments'],
  manager: ['stats', 'data', 'monitor', 'analysis', 'docs', 'shipments'],
};

const ALL_MODULES = ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings', 'shipments'];
