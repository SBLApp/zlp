...
/** Модули интерфейса: stats, data, monitor, analysis, consolidation, docs, settings */
const MODULES_BY_ROLE = {
  admin: ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings'],
  group_leader: ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings'],
  supervisor: ['stats', 'data', 'monitor', 'analysis', 'docs'],
  manager: ['stats', 'data', 'monitor', 'analysis', 'docs'],
};

const ALL_MODULES = ['stats', 'data', 'monitor', 'analysis', 'consolidation', 'docs', 'settings'];
